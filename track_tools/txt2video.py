...
def txt2img(visual_path="visual_val_gt"):
    ...
    color_list = colormap()
    gt_json_path = '/data/mot_blur/annotations/val_half.json' 
    img_path = '/data/mot_blur/train/'
    ...
    test_json_path = '/data/mot_ref/annotations/test.json'
    test_img_path = '/data/mot_ref/test/'
    ...
    for show_video_name in show_video_names:
        ...
        if visual_path == "visual_val_gt":
            txt_path = '/data/mot_snow/train/' + show_video_name + '/gt/gt_val_half.txt'
